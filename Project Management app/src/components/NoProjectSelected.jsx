...
export default function NoProjectSelected({onSelect}){
    return(
        <div className="mt-24 text-center w-2/3">
            <img src={imgsrc} className="w-16 h-16 object-contain mx-auto" />
            ...
            <button className="px-6 py-2 rounded-md bg-stone-800 text-stone-50 hover:bg-stone-950" onClick={onSelect}>Create new project</button>
        </div>
    )
}